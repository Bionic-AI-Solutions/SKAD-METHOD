...
- **SKad Core** (word mark, includes SKadCore, SKAD-CORE, and all variations)
- **SKad Code** (word mark)
- SKad Method logo and visual branding
...
These trademarks are protected under trademark law and are **not** licensed under the MIT License. The MIT License applies to the software code only, not to the SKad brand identity.
...
| ------------------------------------------------------ | -------------------------------------------- |
| "My workflow tool, compatible with SKad Method"        | "SKadFlow" or "SKad Studio"                  |
| "An alternative implementation inspired by SKad"       | "SKad Pro" or "SKad Enterprise"              |
| "My Awesome Healthcare Module (Skad Community Module)" | "The Official SKad Core Healthcare Module"   |
| Accurately stating you use SKad as a dependency        | Implying official endorsement or partnership |

## Commercial Use

You may sell products that incorporate or work with SKad software. However:

- Your product must have its own distinct name and branding
- You must not use SKad trademarks in your marketing, domain names, or product identity
- You may truthfully describe technical compatibility (e.g., "Works with SKad Method")
