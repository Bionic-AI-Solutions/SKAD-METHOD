...
- Read fully and follow: {project-root}/_skad/core/workflows/advanced-elicitation/workflow.md with the current component strategy content
...
- Read fully and follow: {project-root}/_skad/core/workflows/party-mode/workflow.md with the current component strategy
...
- Load `{project-root}/_skad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_skad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md` to define UX consistency patterns.
