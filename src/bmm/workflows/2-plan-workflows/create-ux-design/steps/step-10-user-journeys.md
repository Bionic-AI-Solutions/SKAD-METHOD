...
- Read fully and follow: {project-root}/_skad/core/workflows/advanced-elicitation/workflow.md with the current user journey content
...
- Read fully and follow: {project-root}/_skad/core/workflows/party-mode/workflow.md with the current user journeys
...
- Load `{project-root}/_skad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_skad/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md` to define component library strategy.
