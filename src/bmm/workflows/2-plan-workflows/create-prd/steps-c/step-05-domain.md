...
# File References
nextStepFile: '{project-root}/_skad/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-06-innovation.md'
outputFile: '{planning_artifacts}/prd.md'
domainComplexityCSV: '{project-root}/_skad/bmm/workflows/2-plan-workflows/create-prd/data/domain-complexity.csv'
