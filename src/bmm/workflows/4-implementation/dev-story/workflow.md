...
- `installed_path` = `{project-root}/_skad/bmm/workflows/4-implementation/dev-story`
...
<workflow>
  ...
  <step n="10" goal="Completion communication and user support">
    ...
    <action>Recommended next steps (flexible based on project setup):
      ...
      - Optional: If Test Architect module installed, run `/skad:tea:automate` to expand guardrail tests
    </action>
