...
2. Ensure ralph scripts exist (ralph.sh, ralph-bmad.sh) and are executable.
...
- **[L] Launch now**: Execute `./ralph-bmad.sh test-plan.md {{max_iterations}}`
...
./ralph-bmad.sh test-plan.md {{max_iterations}}
