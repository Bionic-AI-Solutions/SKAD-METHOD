...
main_config: '{project-root}/_skad/bmm/config.yaml'
...
quick_dev_workflow: '{project-root}/_skad/bmm/workflows/skad-quick-flow/quick-dev/workflow.md'
---
...
Read fully and follow: `{project-root}/_skad/bmm/workflows/skad-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.
