...
- **NEXT:** Read fully and follow: `{project-root}/_skad/bmm/workflows/skad-quick-flow/quick-dev/steps/step-03-execute.md`
...
- IF E: Ask for any additional guidance, then **NEXT:** Read fully and follow: `{project-root}/_skad/bmm/workflows/skad-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
**[W] Seems bigger than quick-dev** - Recommend the Full SKad Flow PRD Process
**[E] Execute directly**
...
- IF E: Ask for guidance, then **NEXT:** Read fully and follow: `{project-root}/_skad/bmm/workflows/skad-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
**[W] Start SKad Method** (recommended)
...
- Mode A (tech-spec): "**NEXT:** read fully and follow: `{project-root}/_skad/bmm/workflows/skad-quick-flow/quick-dev/steps/step-03-execute.md`"
- Mode B (direct, [E] selected): "**NEXT:** Read fully and follow: `{project-root}/_skad/bmm/workflows/skad-quick-flow/quick-dev/steps/step-02-context-gathering.md`"
