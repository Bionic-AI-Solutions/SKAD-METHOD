...
- When 'A' selected: Execute {project-root}/_skad/core/workflows/advanced-elicitation/workflow.md
- When 'P' selected: Execute {project-root}/_skad/core/workflows/party-mode
...
- Execute {project-root}/_skad/core/workflows/advanced-elicitation/workflow.md with current category rules
...
After completing all rule categories and user selects 'C' for the final category, load `{project-root}/_skad/bmm/workflows/generate-project-context/steps/step-03-complete.md` to finalize the project context file.
