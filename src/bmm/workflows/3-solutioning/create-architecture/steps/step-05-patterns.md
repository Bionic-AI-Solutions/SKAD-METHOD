...
- Read fully and follow: {project-root}/_skad/core/workflows/advanced-elicitation/workflow.md with current patterns
...
- Read fully and follow: {project-root}/_skad/core/workflows/party-mode/workflow.md with implementation patterns context
...
- Load `{project-root}/_skad/bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_skad/bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md` to define the complete project structure.
