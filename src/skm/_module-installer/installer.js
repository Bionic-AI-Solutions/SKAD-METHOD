...
async function install(options) {
  ...
  try {
    logger.log(chalk.blue('🚀 Installing SKM Module...'));
    ...
    logger.log(chalk.green('✓ SKM Module installation complete'));
    return true;
  } catch (error) {
    logger.error(chalk.red(`Error installing SKM module: ${error.message}`));
    return false;
  }
}
