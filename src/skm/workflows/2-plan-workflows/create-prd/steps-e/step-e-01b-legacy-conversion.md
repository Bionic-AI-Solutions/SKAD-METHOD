...
Analyze legacy PRD against SKAD standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring SKAD standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against SKAD standard
...
**For each SKAD PRD section, analyze:**
...
- Manually check PRD for each SKAD section
...
**[R] Restructure to SKAD** - Full conversion to SKAD format, then apply your edits
...
- All 6 SKAD core sections analyzed for gaps
