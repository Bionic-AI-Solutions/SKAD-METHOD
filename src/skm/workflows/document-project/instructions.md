...
<critical>You MUST have already loaded and processed: {project-root}/_skad/skm/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/_skad/skm/workflows/workflow-status">
...
- Refer to the SKM workflow guide if unsure what to do next
