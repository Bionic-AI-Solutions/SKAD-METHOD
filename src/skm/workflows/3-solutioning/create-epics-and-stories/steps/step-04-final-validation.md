...
# Path Definitions
workflow_path: '{project-root}/_skad/skm/workflows/3-solutioning/create-epics-and-stories'
...
Epics and Stories complete. Read fully and follow: `_skad/core/tasks/help.md` with argument `Create Epics and Stories`.
