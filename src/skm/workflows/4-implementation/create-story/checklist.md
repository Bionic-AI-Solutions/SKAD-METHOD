...
- The `{project-root}/_skad/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project-root}/_skad/core/tasks/validate-workflow.xml`
