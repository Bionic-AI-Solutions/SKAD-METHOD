...
- Show the command prefixed with `/` (e.g., `/skad-bmm-create-prd`)

### Skill-Referenced Workflows
When `workflow-file` starts with `skill:`:
- The value is a skill reference (e.g., `skill:skad-quick-dev-new-preview`), NOT a file path
