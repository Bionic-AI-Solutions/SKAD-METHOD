...
| Skill        | Agent   | Purpose                              |
| ------------ | ------- | ------------------------------------ |
| `skad-brainstorming` | Analyst | Brainstorm a new project             |
| `skad-create-prd`        | PM      | Create Product Requirements Document |
```
...
Yes. The SM agent has a `skad-correct-course` workflow for handling scope changes.
