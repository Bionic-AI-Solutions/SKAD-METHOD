...
在 `_skad-output/project-context.md` 创建文件并添加您的规则：
...
```bash
/skad-bmm-generate-project-context
```
...
:::note[文件位置]
默认位置是 `_skad-output/project-context.md`。工作流在那里搜索它，并且还会检查项目中任何位置的 `**/project-context.md`。
:::
