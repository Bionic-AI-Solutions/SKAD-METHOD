...
:::note[Prerequisites]
- SKAD installed in your project (see [How to Install SKAD](./install-skad.md))
...
```text
_skad/_config/agents/
├── core-skad-master.customize.yaml
├── skm-dev.customize.yaml
├── skm-pm.customize.yaml
...
| **Modify SKAD Installation** | Full installation flow for adding or removing modules        |
...
- Run `npx skad-method install` and select **Recompile Agents** to apply changes
...
- Run `npx skad-method install` and select **Recompile Agents** to restore defaults

## Workflow Customization

Customization of existing SKAD Method workflows and skills is coming soon.
