...
Use SKad Method effectively when working on existing projects and legacy codebases.
...
You can review and refine the generated file, or create it manually at `_skad-output/project-context.md` if you prefer.
...
For complex projects, consider using the `skad-document-project` workflow. It offers runtime variants that will scan your entire project and document its actual current state.

## Step 3: Get Help

### SKad-Help: Your Starting Point

**Run `skad-help` anytime you're unsure what to do next.** This intelligent guide:
...
```
skad-help I have an existing Rails app, where should I start?
skad-help What's the difference between quick-flow and full method?
skad-help Show me what workflows are available
```

SKad-Help also **automatically runs at the end of every workflow**, providing clear guidance on exactly what to do next.
...
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- |
| **Small updates or additions** | Use `skad-quick-flow-solo-dev` to create a tech-spec and implement the change. The full four-phase SKad Method is likely overkill. |
