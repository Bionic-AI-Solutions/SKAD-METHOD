...
class UI {
  ...
  async promptInstall(options = {}) {
    ...
    if (hasExistingInstall) {
      ...
      const shouldProceed = await this.showLegacyVersionWarning(installedVersion, currentVersion, path.basename(skadDir), options);
   ...
   */
  async showLegacyVersionWarning(installedVersion, currentVersion, skadFolderName, options = {}) {
