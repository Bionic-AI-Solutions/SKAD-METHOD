...
class ModuleManager {
  ...
  async install(moduleName, skadDir, fileTrackingCallback = null, options = {}) {
    ...
    if (!options.skipModuleInstaller) {
      await this.createModuleDirectories(moduleName, skadDir, options);
    }
  ...
  async vendorCrossModuleWorkflows(sourcePath, targetPath, moduleName) {
    ...
    for (const agentFile of yamlFiles) {
      ...
      for (const item of workflowInstallItems) {
        ...
        // Example: {project-root}/_skad/bmm/workflows/4-implementation/create-story/workflow.yaml
        // Or: {project-root}/skad/bmm/workflows/4-implementation/create-story/workflow.yaml
   ...
   */
  async createModuleDirectories(moduleName, skadDir, options = {}) {
