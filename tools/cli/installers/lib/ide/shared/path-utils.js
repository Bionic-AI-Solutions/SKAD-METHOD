 ...
 * - bmm/workflows/plan-project.md → skad-bmm-plan-project.md
 * - bmm/tasks/create-story.md → skad-bmm-create-story.md
 ...
 * Converts: 'bmm', 'agents', 'pm' → 'skad-agent-bmm-pm.md'
 * Converts: 'bmm', 'workflows', 'correct-course' → 'skad-bmm-correct-course.md'
 ...
 * @returns {string} Flat filename like 'skad-agent-bmm-pm.md' or 'skad-bmm-correct-course.md'
 */
 ...
 * Converts: 'bmm/agents/pm.md' → 'skad-agent-bmm-pm.md'
 * Converts: 'bmm/agents/tech-writer/tech-writer.md' → 'skad-agent-bmm-tech-writer.md' (uses folder name)
 * Converts: 'bmm/workflows/correct-course.md' → 'skad-bmm-correct-course.md'
 * Converts: 'core/agents/brainstorming.md' → 'skad-agent-brainstorming.md' (core agents skip module name)
 *
 * @param {string} relativePath - Path like 'bmm/agents/pm.md'
 * @returns {string} Flat filename like 'skad-agent-bmm-pm.md' or 'skad-brainstorming.md'
 */
 ...
 * Parses: 'skad-agent-bmm-pm.md' → { prefix: 'skad', module: 'bmm', type: 'agents', name: 'pm' }
 * Parses: 'skad-bmm-correct-course.md' → { prefix: 'skad', module: 'bmm', type: 'workflows', name: 'correct-course' }
 ...
 * Prefers canonicalId from a skad-skill-manifest.yaml sidecar when available,
 ...
 * @returns {string} Filename like 'skad-create-prd.md' or 'skad-agent-bmm-pm.md'
 */
